...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        spectraBox = new QFrame(dockWidgetContents_2);
        spectraBox->setObjectName(QStringLiteral("spectraBox"));
        QSizePolicy sizePolicy3(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy3.setHorizontalStretch(0);
        sizePolicy3.setVerticalStretch(0);
        sizePolicy3.setHeightForWidth(spectraBox->sizePolicy().hasHeightForWidth());
        spectraBox->setSizePolicy(sizePolicy3);

        formLayout->setWidget(2, QFormLayout::LabelRole, spectraBox);
